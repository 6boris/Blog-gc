    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                   <a href="{{URL('admin/sysconfig/role')}}">角色管理</a>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('style/admin/img/a2.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('style/admin/img/a3.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('style/admin/img/a4.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
